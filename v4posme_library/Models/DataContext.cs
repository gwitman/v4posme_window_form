...
public sealed partial class DataContext : DbContext
{
    ...
    public DataContext()
    {
        var connectionString = configuration.GetConnectionString("PosmeConnectionString");
    ...
    public DbSet<TbAccountLevel> TbAccountLevels { get; set; }

    public DbSet<TbAccountTmp> TbAccountTmps { get; set; }

    public DbSet<TbAccountType> TbAccountTypes { get; set; }

    public DbSet<TbAccountingBalance> TbAccountingBalances { get; set; }

    public DbSet<TbAccountingBalanceTemp> TbAccountingBalanceTemps { get; set; }

    public DbSet<TbAccountingCycle> TbAccountingCycles { get; set; }

    public DbSet<TbAccountingPeriod> TbAccountingPeriods { get; set; }

    public DbSet<TbBank> TbBanks { get; set; }

    public DbSet<TbBiblia> TbBiblias { get; set; }

    public DbSet<TbBranch> TbBranches { get; set; }

    public DbSet<TbCaller> TbCallers { get; set; }

    public DbSet<TbCashBox> TbCashBoxes { get; set; }

    public DbSet<TbCashBoxSession> TbCashBoxSessions { get; set; }

    public DbSet<TbCashBoxSessionTransactionMaster> TbCashBoxSessionTransactionMasters { get; set; }

    public DbSet<TbCashBoxUser> TbCashBoxUsers { get; set; }

    public DbSet<TbCatalog> TbCatalogs { get; set; }

    public DbSet<TbCatalogItem> TbCatalogItems { get; set; }

    public DbSet<TbCatalogItemConvertion> TbCatalogItemConvertions { get; set; }

    public DbSet<TbCenterCost> TbCenterCosts { get; set; }

    public DbSet<TbCompany> TbCompanies { get; set; }

    public DbSet<TbCompanyComponent> TbCompanyComponents { get; set; }

    public DbSet<TbCompanyComponentConcept> TbCompanyComponentConcepts { get; set; }

    public DbSet<TbCompanyComponentFlavor> TbCompanyComponentFlavors { get; set; }

    public DbSet<TbCompanyComponentItemDataview> TbCompanyComponentItemDataviews { get; set; }

    public DbSet<TbCompanyCurrency> TbCompanyCurrencies { get; set; }

    public DbSet<TbCompanyDataview> TbCompanyDataviews { get; set; }

    public DbSet<TbCompanyDefaultDataview> TbCompanyDefaultDataviews { get; set; }

    public DbSet<TbCompanyParameter> TbCompanyParameters { get; set; }

    public DbSet<TbCompanySubelementAudit> TbCompanySubelementAudits { get; set; }

    public DbSet<TbCompanySubelementObligatory> TbCompanySubelementObligatories { get; set; }

    public DbSet<TbComponent> TbComponents { get; set; }

    public DbSet<TbComponentAudit> TbComponentAudits { get; set; }

    public DbSet<TbComponentAuditDetail> TbComponentAuditDetails { get; set; }

    public DbSet<TbComponentAutorization> TbComponentAutorizations { get; set; }

    public DbSet<TbComponentAutorizationDetail> TbComponentAutorizationDetails { get; set; }

    public DbSet<TbComponentElement> TbComponentElements { get; set; }

    public DbSet<TbCounter> TbCounters { get; set; }

    public DbSet<TbCreditLine> TbCreditLines { get; set; }

    public DbSet<TbCurrency> TbCurrencies { get; set; }

    public DbSet<TbCustomer> TbCustomers { get; set; }

    public DbSet<TbCustomerConsultasSinRiesgo> TbCustomerConsultasSinRiesgoes { get; set; }

    public DbSet<TbCustomerCredit> TbCustomerCredits { get; set; }

    public DbSet<TbCustomerCreditAmoritization> TbCustomerCreditAmoritizations { get; set; }

    public DbSet<TbCustomerCreditClasification> TbCustomerCreditClasifications { get; set; }

    public DbSet<TbCustomerCreditDocument> TbCustomerCreditDocuments { get; set; }

    public DbSet<TbCustomerCreditDocumentEntityRelated> TbCustomerCreditDocumentEntityRelateds { get; set; }

    public DbSet<TbCustomerCreditLine> TbCustomerCreditLines { get; set; }

    public DbSet<TbDataview> TbDataviews { get; set; }

    public DbSet<TbElement> TbElements { get; set; }

    public DbSet<TbElementType> TbElementTypes { get; set; }

    public DbSet<TbEmployee> TbEmployees { get; set; }

    public DbSet<TbEmployeeCalendarPay> TbEmployeeCalendarPays { get; set; }

    public DbSet<TbEmployeeCalendarPayDetail> TbEmployeeCalendarPayDetails { get; set; }

    public DbSet<TbEntity> TbEntities { get; set; }

    public DbSet<TbEntityAccount> TbEntityAccounts { get; set; }

    public DbSet<TbEntityEmail> TbEntityEmails { get; set; }

    public DbSet<TbEntityPhone> TbEntityPhones { get; set; }

    public DbSet<TbError> TbErrors { get; set; }

    public DbSet<TbEstadisticaCategoria> TbEstadisticaCategorias { get; set; }

    public DbSet<TbEstadisticaClas> TbEstadisticaClases { get; set; }

    public DbSet<TbExchangeRate> TbExchangeRates { get; set; }

    public DbSet<TbFixedAssent> TbFixedAssents { get; set; }

    public DbSet<TbIndicator> TbIndicators { get; set; }

    public DbSet<TbIndicatorHistory> TbIndicatorHistories { get; set; }

    public DbSet<TbIndicatorTmp> TbIndicatorTmps { get; set; }

    public DbSet<TbItem> TbItems { get; set; }

    public DbSet<TbItemCategory> TbItemCategories { get; set; }

    public DbSet<TbItemConfigLoto> TbItemConfigLotoes { get; set; }

    public DbSet<TbItemDataSheet> TbItemDataSheets { get; set; }

    public DbSet<TbItemDataSheetDetail> TbItemDataSheetDetails { get; set; }

    public DbSet<TbItemSku> TbItemSkus { get; set; }

    public DbSet<TbItemWarehouse> TbItemWarehouses { get; set; }

    public DbSet<TbItemWarehouseExpired> TbItemWarehouseExpireds { get; set; }

    public DbSet<TbJournalEntry> TbJournalEntries { get; set; }

    public DbSet<TbJournalEntryDetail> TbJournalEntryDetails { get; set; }

    public DbSet<TbJournalEntryDetailSummary> TbJournalEntryDetailSummaries { get; set; }

    public DbSet<TbKardex> TbKardexes { get; set; }

    public DbSet<TbLegal> TbLegals { get; set; }

    public DbSet<TbListPrice> TbListPrices { get; set; }

    public DbSet<TbLog> TbLogs { get; set; }

    public DbSet<TbLogMesseger> TbLogMessegers { get; set; }

    public DbSet<TbLogSession> TbLogSessions { get; set; }

    public DbSet<TbMasterKardexTemp> TbMasterKardexTemps { get; set; }

    public DbSet<TbMembership> TbMemberships { get; set; }

    public DbSet<TbMenuElement> TbMenuElements { get; set; }

    public DbSet<TbNaturale> TbNaturales { get; set; }

    public DbSet<TbNotification> TbNotifications { get; set; }

    public DbSet<TbParameter> TbParameters { get; set; }

    public DbSet<TbPrice> TbPrices { get; set; }

    public DbSet<TbProvider> TbProviders { get; set; }

    public DbSet<TbProviderItem> TbProviderItems { get; set; }

    public DbSet<TbPublicCatalog> TbPublicCatalogs { get; set; }

    public DbSet<TbPublicCatalogDetail> TbPublicCatalogDetails { get; set; }

    public DbSet<TbRazonesFinancierasTmp> TbRazonesFinancierasTmps { get; set; }

    public DbSet<TbRelationship> TbRelationships { get; set; }

    public DbSet<TbRemember> TbRemembers { get; set; }

    public DbSet<TbRole> TbRoles { get; set; }

    public DbSet<TbRoleAutorization> TbRoleAutorizations { get; set; }

    public DbSet<TbSubelement> TbSubelements { get; set; }

    public DbSet<TbTag> TbTags { get; set; }

    public DbSet<TbTransaction> TbTransactions { get; set; }

    public DbSet<TbTransactionCausal> TbTransactionCausals { get; set; }

    public DbSet<TbTransactionConcept> TbTransactionConcepts { get; set; }

    public DbSet<TbTransactionMaster> TbTransactionMasters { get; set; }

    public DbSet<TbTransactionMasterConcept> TbTransactionMasterConcepts { get; set; }

    public DbSet<TbTransactionMasterDenomination> TbTransactionMasterDenominations { get; set; }

    public DbSet<TbTransactionMasterDetail> TbTransactionMasterDetails { get; set; }

    public DbSet<TbTransactionMasterDetailCredit> TbTransactionMasterDetailCredits { get; set; }

    public DbSet<TbTransactionMasterDetailTemp> TbTransactionMasterDetailTemps { get; set; }

    public DbSet<TbTransactionMasterInfo> TbTransactionMasterInfoes { get; set; }

    public DbSet<TbTransactionMasterPurchase> TbTransactionMasterPurchases { get; set; }

    public DbSet<TbTransactionMasterSummaryConceptTmp> TbTransactionMasterSummaryConceptTmps { get; set; }

    public DbSet<TbTransactionProfileDetail> TbTransactionProfileDetails { get; set; }

    public DbSet<TbTransactionProfileDetailTmp> TbTransactionProfileDetailTmps { get; set; }

    public DbSet<TbTypeMenuElement> TbTypeMenuElements { get; set; }

    public DbSet<TbUser> TbUsers { get; set; }

    public DbSet<TbUserPermission> TbUserPermissions { get; set; }

    public DbSet<TbUserTag> TbUserTags { get; set; }

    public DbSet<TbUserWarehouse> TbUserWarehouses { get; set; }

    public DbSet<TbWarehouse> TbWarehouses { get; set; }

    public DbSet<TbWorkflow> TbWorkflows { get; set; }

    public DbSet<TbWorkflowStage> TbWorkflowStages { get; set; }

    public DbSet<TbWorkflowStageChangeLog> TbWorkflowStageChangeLogs { get; set; }

    public DbSet<TbWorkflowStageRelation> TbWorkflowStageRelations { get; set; }

    public DbSet<VwContabilidadComprobante> VwContabilidadComprobantes { get; set; }

    public DbSet<VwGerenciaBalance> VwGerenciaBalances { get; set; }

    public DbSet<VwGerenciaCustomer> VwGerenciaCustomers { get; set; }

    public DbSet<VwGerenciaDesembolsosDetalle> VwGerenciaDesembolsosDetalles { get; set; }

    public DbSet<VwGerenciaDesembolsosResuman> VwGerenciaDesembolsosResumen { get; set; }

    public DbSet<VwGerenciaEstadoResultado001> VwGerenciaEstadoResultado001 { get; set; }

    public DbSet<VwGerenciaEstadoResultado002> VwGerenciaEstadoResultado002 { get; set; }

    public DbSet<VwSalesInventory> VwSalesInventories { get; set; }

    public DbSet<VwSinRiesgoReporteCliente> VwSinRiesgoReporteClientes { get; set; }

    public DbSet<VwSinRiesgoReporteCredito> VwSinRiesgoReporteCreditos { get; set; }

    public DbSet<VwSinRiesgoReporteCreditosToSystema> VwSinRiesgoReporteCreditosToSystemas { get; set; }

    public DbSet<VwTransaccionMasterConcept232425> VwTransaccionMasterConcept232425 { get; set; }
