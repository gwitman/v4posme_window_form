...
public sealed partial class DataContext : DbContext
{
    ...
    public DbSet<TbCustomerCreditExternalSharon> TbCustomerCreditExternalSharons { get; set; } = null!;

    public DbSet<TbCustomerCreditExternalSharonTmp> TbCustomerCreditExternalSharonTmps { get; set; } = null!;
    ...
    public DbSet<TbItemImport> TbItemImports { get; set; } = null!;
    ...
    public DbSet<VwCxcCustomerListRealEstate> VwCxcCustomerListRealEstates { get; set; } = null!;
    ...
    public DbSet<VwInventoryListItemRealEstate> VwInventoryListItemRealEstates { get; set; } = null!;
