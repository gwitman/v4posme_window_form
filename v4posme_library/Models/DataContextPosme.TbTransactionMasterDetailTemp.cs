...
namespace v4posme_library.Models
{
    public partial class TbTransactionMasterDetailTemp {
        ...
        public TbTransactionMasterDetailTemp(int transactionMasterDetailTemporalID, string? token, int? componentItemID, int? promotionID, decimal? amount, decimal? cost, decimal? quantity, decimal? discount, decimal? unitaryAmount, decimal? tax1, decimal? tax2, decimal? tax3, decimal? tax4, decimal? unitaryCost, decimal? unitaryPrice, string? reference1, string? reference2, string? reference3, string? reference4, string? reference5, string? reference6, string? reference7, string? descriptionReference, decimal? exchangeRateReference, int? catalogStatusID, int? inventoryStatusID, bool? isActive, decimal? quantityStock, decimal? quantiryStockInTraffic, decimal? quantityStockUnaswared, decimal? remaingStock, DateTime? expirationDate, int? inventoryWarehouseSourceID, int? inventoryWarehouseTargetID, string? skuFormatoDescription, string? itemNameLog) : this()        {
            this.TransactionMasterDetailTemporalID = transactionMasterDetailTemporalID;
            this.Token = token;
