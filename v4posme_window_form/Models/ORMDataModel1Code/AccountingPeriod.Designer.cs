...
namespace v4posme_window_form.Models.dbkroqnguhldo1
{
    ...
    [Persistent(@"tb_accounting_period")]
    public partial class AccountingPeriod : XPLiteObject
    {
        ...
        int fCompanyID;
        [Indexed(Name = @"IDX_ACCOUNTING_PERIOD_001")]
        ...
        int fComponentID;
        [Indexed(Name = @"IDX_ACCOUNTING_PERIOD_002")]
        ...
        int fStatusID;
        [Indexed(Name = @"IDX_ACCOUNTING_PERIOD_003")]
        [Persistent(@"statusID")]
        [ColumnDefaultValue(0)]
        public int StatusID
        {
