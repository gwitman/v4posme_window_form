...
namespace v4posme_window.Views
{
    public partial class FormInvoiceBillingEdit : Form, IFormTypeEdit
    {
        ...
        private readonly IBindingList _bindingListDatos = new BindingList<BillingEdit>();
        ...
        public FormInvoiceBillingEdit(TypeOpenForm typeOpen, int companyId, int transactionId, int transactionMasterId)
        {
            ...
            gridViewTbTransactionMasterDetail.DataSource = new BindingList<BillingEdit>() /* TODO: Assign the real data here.*/;
        }
        ...
        private void FormInvoiceBillingEdit_Load(object sender, EventArgs e)
        {
            ...
            gridViewTbTransactionMasterDetail.DataSource = _bindingListDatos;
        }
        ...
        public void PreRender()
        {
            ...
            //var repositoryItemButtonEdit = new RepositoryItem();
        ...
        private void EventoCallBackAceptarItem(dynamic mensaje)
        {
            ...
            var objDynamic = (IDictionary<string, object>)mensaje;

            var billingEdit = new BillingEdit
            {
                CheckDetail = false,
                Sku = (string)objDynamic["Medida"],
                ItemNumber = Convert.ToInt32(objDynamic["itemID"]),
                TransactionDetailName = objDynamic["Descripcion"].ToString(),
                Quantity = Convert.ToDecimal(objDynamic["Cantidad"]),
                Price = Convert.ToDecimal(objDynamic["Precio"]),
                ItemPrecio2 = Convert.ToDecimal(objDynamic["Precio2"]),
                ItemPrecio3 = Convert.ToDecimal(objDynamic["Precio3"])
            };

            _bindingListDatos.Add(billingEdit);
        }
        ...
        private void txtScanerCodigo_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            var currencyID_ = Convert.ToInt32((txtCurrencyID.EditValue as ComboBoxItem).Key);
            ...
            for (i = 0; i < ObjSELECCIONAR_ITEM_BILLING_BACKGROUND.Rows.Count; i++)
            {
                ...
                var warehouseID = Convert.ToInt32(((ComboBoxItem)txtWarehouseID.EditValue).Key);
