        ...
        public void LoadRender(TypeRender typeRedner)
        {
            ...
            switch (typeRedner)
            {
                ...
                case TypeRender.Edit:
                    ...
                    txtRealStateRoomBatchServices.Checked = ObjItem.RealStateRoomBatchServices is null ? false :  ObjItem.RealStateRoomBatchServices!.Value == 1;
                    txtRealStateRooBatchVisit.Checked = ObjItem.RealStateRooBatchVisit is null ? false : ObjItem.RealStateRooBatchVisit!.Value == 1;
                    txtRealStateRoomServices.Checked = ObjItem.RealStateRoomServices is null ? false : ObjItem.RealStateRoomServices!.Value == 1;
                    txtRealStateWallInCloset.Checked = ObjItem.RealStateWallInCloset is null ? false : ObjItem.RealStateWallInCloset!.Value == 1;
                    txtRealStatePiscinaPrivate.Checked = ObjItem.RealStatePiscinaPrivate is null ? false : ObjItem.RealStatePiscinaPrivate!.Value == 1;
                    txtRealStateClubPiscina.Checked = ObjItem.RealStateClubPiscina is null ? false : ObjItem.RealStateClubPiscina!.Value == 1;
                    txtRealStateAceptanMascota.Checked = ObjItem.RealStateAceptanMascota is null ? false : ObjItem.RealStateAceptanMascota!.Value == 1;
                    txtRealStateContractCorrentaje.Checked = ObjItem.RealStateContractCorrentaje is null ? false : ObjItem.RealStateContractCorrentaje!.Value == 1;
                    txtRealStatePlanReference.Checked = ObjItem.RealStatePlanReference is null ? false : ObjItem.RealStatePlanReference!.Value == 1;
