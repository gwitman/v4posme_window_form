...
namespace v4posme_window.Views.Inventory.Inputunpost
{
    public partial class FormInventoryInputEdit : FormTypeHeadEdit, IFormTypeEdit
    {
        ...
        public void LoadRender(TypeRender typeRedner)
        {
            ...
            switch (typeRedner)
            {
                case TypeRender.New:
                    ...
                    txtProviderId = ProviderDefault.EntityID;
                ...
                case TypeRender.Edit:
                    ...
                    txtProviderId = ObjProvider.EntityID;
                    ...
                    renderGridFiles = new RenderFileGridControl(user.CompanyID, ObjComponent!.ComponentID, TransactionMasterId);
        ...
        private void FnOnCompleteNewProvider(Dictionary<string, string> diccionario, bool b)
        {
            Invoke(() =>
            {
                txtProviderId = WebToolsHelper.ConvertToNumber<int>(diccionario["entityID"]);
        ...
        private void btnNewDetailTransaction_Click(object sender, EventArgs e)
        {
            ...
            var formTypeListSearch = new FormTypeListSearch("Lista de Productos", ObjComponentItem!.ComponentID,
                "SELECCIONAR_ITEM_TO_PROVIDER", true, @"{providerID:" + txtProviderId + ",currencyID:" + currencyIdKey + "}",
