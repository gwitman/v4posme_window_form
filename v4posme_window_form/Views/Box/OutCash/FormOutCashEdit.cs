...
namespace v4posme_window.Views.Box.OutCash
{
    public partial class FormOutCashEdit : FormTypeHeadEdit, IFormTypeEdit
    {
        ...
        private void gridViewTransactionMaster_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                e.SuppressKeyPress = true;
                // Mover a la siguiente fila
                int currentRow = gridViewTransactionMaster.FocusedRowHandle;
                gridViewTransactionMaster.FocusedRowHandle = currentRow + 1;
            }
        }
